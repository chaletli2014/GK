	...
	<div class="modal-dialog" style="width:70%">
		<div class="modal-content">
			...
			<div id="rootwizard" class="form-wizard">
				<ul class="tabs">
					<li class="active">
						<a href="#other_tab_basic" data-toggle="tab">基本信息</a>
					</li>
					<li>
						<a href="#other_tab_main" data-toggle="tab">主要参数</a>
					</li>
					<li>
						<a href="#other_tab_source" data-toggle="tab">资料库</a>
					</li>
				</ul>
				...
				<div class="tab-content">
					<!-- Tabs Content -->
					<div class="tab-pane active" id="other_tab_basic">
								...
								<div class="form-group">
										...
										<div class="col-sm-6">
											<div class="input-group">
												...
												<input type="text" class="form-control" id="subjectName_other" name="subjectName" disabled="disabled">
												<span class="input-group-addon">构件</span>
												<input type="text" class="form-control" id="moduleName_other" name="moduleName" disabled="disabled">
											</div>
										</div>
									</div>
									<div class="form-group">
					...
					<div class="tab-pane" id="other_tab_main">
						<jsp:include page="housePaintMain.jsp" flush="true">
				        	<jsp:param name="basePath" value="<%=basePath%>"/>
				        </jsp:include>
					</div>
					</form>
					<div class="tab-pane" id="other_tab_source">
					<%--
