			...
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="col-md-12">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label form_input_required" for="spName">组件商名称</label>
							<div class="col-sm-4">
								<input type="text" class="form-control" id="spName" name="spName" value="${moduleSP.moduleSPName}" data-validate="required" data-message-required="名称不能为空">
							</div>
						</div>
						<div class="form-group">
